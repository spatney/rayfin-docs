...
> [!NOTE]
> `@microsoft/rayfin-functions` is an experimental package and may change substantially.
...
- **[Writing a function](/docs/functions/writing-functions)** — project layout,
  `function_app.ts`, `RayfinContext`, and local development.
...
After adding it, tell me how to run it locally with `npx rayfin dev functions apply` and how
to call it from the frontend.
```
