...
No personal data, parameter values, or file contents are collected — arguments you pass
(project names, workspace names, connection strings, file paths) are never sent.
