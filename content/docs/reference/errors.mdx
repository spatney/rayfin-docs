...
**Fix:** run it from an interactive terminal. There is no supported way to set secrets
from CI today. See [Secrets](/docs/deploy/secrets).
...
**Cause:** the signed-in account doesn't have access to the target Fabric workspace, or
