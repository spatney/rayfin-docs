...
flowchart TB
  ...
  class Entra,MSRes,AnyApi external
```
...
> [!WARNING]
> Functions, blob storage, and delegated authentication are experimental and are not
> available in every Fabric region or tenant. Confirm availability in your tenant before
> you depend on them.
